...
public class CodeGenerator {
    ...
    public void emit(OpCode opCode) {
      //metodo per inserire istruzion senza operandi nella lista della istruzioni
        instructions.add(new Instruction(opCode));
    }

    public void emit(OpCode opCode , int operand) {
      //metodo per inserire istruzion con operandi nella lista della istruzioni
        instructions.add(new Instruction(opCode, operand));
    }

    public void emitLabel(int operand) {
      //inserisce un'etichetta nell'Output Jasmin
        emit(OpCode.label, operand);
    }

    public int newLabel() {
      //crea una nova etichetta
        return label++;
    }

    public void toJasmin() throws IOException{
      //Converte le istruzioni nella lista in codice Jasmin e lo scrive in un file chiamato "Output.j"
